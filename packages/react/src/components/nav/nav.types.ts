 ...
 */
export type NavItemProps<C extends ElementType = ElementType> = PolymorphicProps<C, NavItemBaseProps>

/* Component types for namespace */
type NavItemComponent = ForwardRefExoticComponent<NavItemProps & RefAttributes<HTMLButtonElement | HTMLAnchorElement>>
