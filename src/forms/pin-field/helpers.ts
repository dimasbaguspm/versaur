...
/**
 * Validates if a string contains only digits and is at most 6 characters long
 */
export const isValidPinValue = (value: string): boolean => {
  return /^\d{0,6}$/.test(value)
}

/**
 * Formats a value to ensure it only contains digits and is at most 6 characters
 */
export const formatPinValue = (value: string): string => {
