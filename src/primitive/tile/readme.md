...
A flexible box container component that provides a foundation for content layouts with various
styling options.
...
<Tile as="section" variant="neutral">
  Section content
</Tile>
...
| as        | 'div' \| 'section' \| 'article' \| 'aside' | 'div'     | Element type to render as  |
...
<Tile variant='info' size='lg' className='max-w-md'>
  ...
  <p className='text-sm mb-4'>
    This tile component can be used to create beautiful information cards with soft backgrounds and
    proper spacing.
  </p>
  <div className='flex gap-2'>
    <span className='text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded'>Tag 1</span>
    <span className='text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded'>Tag 2</span>
  </div>
</Tile>
```
...
This component follows the **Regular Pattern** as it enhances a basic HTML div element with styling
variants while maintaining familiar behavior and a simple props-based API.
